...
break
   ...
   m.sender.split("@")[0]
    ...
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'https://Wa.me/62858645620244', // Command (URL in this case)
        'cta_url', // Button type
        'https://Wa.me/62858645620244' // URL (used in image generation)
    ], 
];
...
case 'delowner':
if (!XeonTheCreator) return XeonStickOwner()
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 62858645620244`)
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
XeonBotInc.sendMessage("62858645620244@s.whatsapp.net", { text: "🌹 Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
